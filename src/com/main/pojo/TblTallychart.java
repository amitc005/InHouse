...
/**
 * TblTallychart generated by hbm2java
 */
@Entity
@Table(name="tbl_tallychart"
    ,catalog="db_manager"
)
public class TblTallychart  implements java.io.Serializable {
    ...
    public TblTallychart() {
    }

	
    public TblTallychart(String txtId, String txtDeptId, String txtTransactionType) {
        this.txtId = txtId;
        this.txtDeptId = txtDeptId;
        this.txtTransactionType = txtTransactionType;
    }
    public TblTallychart(String txtId, String txtDeptId, String txtTransactionType, String txtPersonName, Integer txtAmount, String txtDescription, Date txtEntryDate, String txtEnteredBy, Character txtIsDelete, Character txtIsActive) {
       this.txtId = txtId;
       this.txtDeptId = txtDeptId;
       this.txtTransactionType = txtTransactionType;
