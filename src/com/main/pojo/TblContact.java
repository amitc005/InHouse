...
/**
 * TblContact generated by hbm2java
 */
@Entity
@Table(name="tbl_contact"
    ,catalog="db_manager"
)
public class TblContact  implements java.io.Serializable {
    ...
    public TblContact(String txtId) {
        this.txtId = txtId;
    }
    public TblContact(String txtId, String txtStudentName, String txtContactNumber, String txtEmailId, String txtEnquiredFrom, Character txtIsDelete, Date txtEntryDate, Character txtIsActive) {
       this.txtId = txtId;
