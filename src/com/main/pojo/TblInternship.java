...
/**
 * TblInternship generated by hbm2java
 */
@Entity
@Table(name="tbl_internship"
    ,catalog="db_manager"
)
public class TblInternship  implements java.io.Serializable {
    ...
    public TblInternship() {
    }

	
    public TblInternship(String txtId, String txtCollegeName, String txtBranchName, String txtTechnologyName) {
        this.txtId = txtId;
        this.txtCollegeName = txtCollegeName;
        this.txtBranchName = txtBranchName;
        this.txtTechnologyName = txtTechnologyName;
    }
    public TblInternship(String txtId, String txtStudentName, String txtEmailId, String txtContactNumber, String txtCollegeName, String txtBranchName, String txtTechnologyName, String txtEnquiredFrom, Character txtIsActive, Date txtEntryDate) {
       this.txtId = txtId;
