        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="../ProjectInquiryServlet" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        <div class="control-group" style="background-color: white;">
                            ...
                            <div class="span11">
                                <div class="span6"  style="float: left">
                                    ...
                                    <div class="controls">
                                        <select class="span12" style="text-transform: uppercase" autofocus="" name="txtProjectCategory" id="txtDomain">
                            ...
                            <div class="span11">
                                ...
                                <div class="span6"  style="float: left">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="txtStudentName" value="${tblProjectInquiry.txtStudentName}" maxlength="30" minlength="10" class="span12"  required="" placeholder="STUDENT NAME" />
                                    </div>
                                </div>
                            </div>
                            <div class="span11">
                                <div class="span6"  style="float: left">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="txtMobileNo"  onKeyPress="return isNumberKey(event)" value="${tblProjectInquiry.txtMobileNo}" maxlength="10" required="" minlength="8"  class="span12"   placeholder="MOBILE NO" />
                                    </div>
                                </div>
                                <div class="span6"  style="float: left">
                                    <label class="control-label ">EMAIL&nbsp;ID&nbsp;:&nbsp;</label>
                                    <div class="controls">
                                        <input type="email" name="txtEmailId" value="${tblProjectInquiry.txtEmailId}" maxlength="20" required="" minlength="8"  class="span12"   placeholder="EMAIL" />
                                    </div>
                                </div>
                            </div>
                            <div class="span11">
                                <div class="span6"  style="float: left">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="txtCollegeName" value="${tblProjectInquiry.txtCollegeName}" maxlength="30" required="" minlength="8"  class="span12"   placeholder="COLLEGE" />
                                    </div>
                                </div>
                                <div class="span6"  style="float: left">
                                    <label class="control-label ">CITY&nbsp;NAME&nbsp;:&nbsp;</label>
                                    <div class="controls">
                                        <input type="text" name="txtCityName" value="${tblProjectInquiry.txtCityName}" maxlength="20" required="" minlength="8"  class="span12"   placeholder="CITY" />
                                    </div>
                                </div>
                            </div>
                            <div class="span11">
                                <div class="span6"  >
                                    ...
                                    <div class="controls">
                                        <input type="text" name="txtReferBy" value="${tblProjectInquiry.txtReferBy}" maxlength="30" class="span12"  required="" placeholder="REFER BY" />
                                    </div>
                                </div>
                            </div>
                            <div class="span11">
                                <div class="span11"  >
                                    <label class="control-label ">PROJECT&nbsp;BUGGED&nbsp;:&nbsp;</label>
                                    <div class="controls">
                                        <input type="text" name="txtProjectBuged" value="${tblProjectInquiry.txtProjectBuged}" maxlength="30" class="span12"  required="" placeholder="BUGGED" />
                                    </div>
                                </div>
                            </div>
                            <div class="span11">
                                <div class="span11">
                                    <input type="text" name="txtDetails" value="${tblProjectInquiry.txtDetails}" maxlength="200" class="span12"  required="" placeholder="DETAILS"" style="margin-left: 160px;"/>
                                </div>
                            </div>
                            <div class="span11" style="clear: both "></div>
                        </div>
