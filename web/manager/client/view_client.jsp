                            ...
                            <table class="table table-bordered table-striped" style="text-transform: capitalize">
                                ...
                                <tbody>
                                    <c:forEach var="client" items="${pageScope.tblClients}"> 
                                        <tr>
                                            <td><a href="../<%=IServletConstant.PAGE_ADD_CLIENT%>&clientId=${client.clientId}"><i class="icon-pencil"></i></a></td>
                                            <td><a href="../<%=IServletConstant.PAGE_DELETE_CLIENT%>&clientId=${client.clientId}"><i class="icon-remove"></i></a></td>
                                            <td><a  href="../<%=IServletConstant.PAGE_ADD_QUOTATION %>&clientId=${client.clientId}&mode=quotation"  title="ADD QUOTATION"><i class="icon-beer"></i></a> </td>
                                            <td><a href="../<%=IServletConstant.PAGE_ADD_ORDER %>&clientId=${client.clientId}&mode=order" title="ADD ORDER"><i class="icon-file"></i></a> </td>
